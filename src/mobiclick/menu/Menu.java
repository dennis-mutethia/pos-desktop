...
import mobiclick.menu.mode.LightDarkMode;
...
import mobiclick.menu.mode.ToolBarAccentColor;
...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        ...
        {"Purchases", "Open Purchase Orders", "Received Orders", "Suppliers"},
        {"~SALES~"},
        {"Customers", "My Customers", "Customer Bills"},
        {"Expenses"},
        {"CashBox"},
        {"~REPORTS~"},
        {"Reports", "Stock Report", "Bills Report", "Purchases Report", "Expenses Report", "Profit & Loss Report", "Statement of Account"},
        {"~OTHER~"},
    ...
    private final String headerName = "Matrix POS";
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("/mobiclick/icon/png/logo.png")));
